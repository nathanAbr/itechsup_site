<?php
	...
	$this->set_css($this->default_theme_path.'/bootstrap/css/edit.css');
...
<div class='ui-widget-content ui-corner-all'>
	<h3 class="ui-accordion-header ui-helper-reset form-title">
		<div class='floatL form-title-left'>
			<h3 href="#"><?php echo $this->l('form_edit'); ?> <?php echo $subject?></h3>
		</div>
	</h3>
	<div class="row">
		<div class="col-md-9 col-md-offset-1 form-horizontal">
			...
			<?php echo form_open( $update_url, 'method="post" id="crudForm" enctype="multipart/form-data"'); ?>
				...
				?>
					<div class='form-group form-field-box <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
						<div class='form-display-as-box col-md-3 control-label' id="<?php echo $field->field_name; ?>_display_as_box">
