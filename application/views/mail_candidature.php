...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
     ...
     <div style="Margin-left: 20px;Margin-right: 20px;">
      <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #706f70;font-size: 24px;line-height: 26px;font-family: Cabin,Avenir,sans-serif;">Demande de candidature</h1><strong>
      <p style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #706f70;font-size: 18px;line-height: 26px;font-family: Cabin,Avenir,sans-serif;"><strong>
      <?php echo $nom; ?></br>
      <?php echo $prenom; ?></br>
      <?php echo $adresse; ?></br>
      <?php echo $cp; ?>&nbsp;<?php echo $ville; ?></br>
      <?php echo $tel; ?></br>
      <?php echo $mail; ?></br>
      </strong></p>
      <p style="Margin-top: 16px;Margin-bottom: 20px;">Dernier diplôme obtenu: <?php echo $diplome; ?></p>
      <p style="Margin-top: 16px;Margin-bottom: 20px;">Commentaires : <?php echo $sup; ?></p>
    </div>
