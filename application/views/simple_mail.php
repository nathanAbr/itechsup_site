...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="line-height:10px;font-size:1px">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #706f70;font-size: 18px;line-height: 26px;font-family: Cabin,Avenir,sans-serif;"><strong>Votre demande à bien été prise en compte.</strong></h2><p style="Margin-top: 16px;Margin-bottom: 20px;">Proposant des formations de BAC+2 à BAC+5 professionnalisante dans les domaines de l'informatique des ressources humaines et du commerce, ainsi qu'un suivis individuel et une aide à la recherche d'entreprise, boostez votre avenir en nous rejoignant.</p>
    </div>
